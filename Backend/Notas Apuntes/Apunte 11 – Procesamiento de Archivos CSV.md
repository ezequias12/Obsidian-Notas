...
Este bloque proporciona un ejemplo completo y funcional que integra la definición del POJO, la carga del CSV con `CsvToBean` y varias consultas usando Streams y Collectors, demostrando cómo aplicar todo lo aprendido en un escenario real.
...
¿Qué te parece? ¿Hay algo que quieras agregar o modificar?